...
from Game.Roles.Rooks import *
from Game.Roles.Queens import *
from Game.Roles.Bishops import *
from Game.Roles.Kings import *
from Game.Roles.Pawns import *
from Game.Roles.Knights import *
    ...
    def draw_Board(self):
        ...
        for row in range(Rows):
            for col in range(row % 2, Cols, 2):
                pygame.draw.rect(self.Win, camel, (Square * (row), Square * (col), Square, Square))
